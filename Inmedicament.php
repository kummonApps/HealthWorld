...
<header id="header">
  ...
  <br>
  <details>
        <summary id="asmastrong"><strong>Characteristics</strong></summary>
        <div class="content">
        <?php 
            echo("<form class='form-inline' action='Esperfil_doctor.php' method = 'GET'>Name: " .$fila[2]."<br>Barcode: ". $fila[3] ."</form>");
            
        ?>
        </div>
    </details>
    <details>
        <summary id="asmastrong"><strong>Composition</strong></summary>
        <div class="content">
        <?php 
    ...
    <details>
        <summary id="asmastrong"><strong>Comments</strong></summary>
        <div class="content">
        <?php 
            echo("<form class='form-inline' action='Esperfil_doctor.php' method = 'GET'>" .$fila[4] ."</form>");
        ?>         
          </div>
    </details>
    <details>
        <summary id="asmastrong"><strong>Pharmaceutical form</strong></summary>
        <div class="content">
        <?php 
    ...
    <details>
        <summary id="asmastrong"><strong>Laboratory</strong></summary>
        <div class="content">
        <?php 
    ...
    <details>
        <summary id="asmastrong"><strong>Symptomatology</strong></summary>
        <div class="content">
        <?php 
            echo("<form class='form-inline' action='Esperfil_doctor.php' method = 'GET'>" .$fila[1] ."</form>");
        ?>         
